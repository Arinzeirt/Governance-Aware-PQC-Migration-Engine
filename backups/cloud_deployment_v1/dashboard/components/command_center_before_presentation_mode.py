...
def show_command_center():
    ...
    # Executive Assessment replaces the old Runtime panel
    ...
    if not runtime["complete"]:
        st.info(
            "Assessment in progress. Executive intelligence will appear automatically when the assessment completes."
        )
        return
