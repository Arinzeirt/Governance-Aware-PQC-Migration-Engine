...
st.markdown("""
# PQC Migration Command Center

<span class="small-muted">
Governance-aware cryptographic discovery, classification, coverage assessment, and migration decision support.
</span>
""", unsafe_allow_html=True)
...
<p class="small-muted">Cryptographic assets discovered</p>
</div>
""", unsafe_allow_html=True)
...
<div class="metric-card">
<h4>High Priority</h4>
<h2 class="risk-high">{high_priority}</h2>
<p class="small-muted">Requires near-term migration</p>
</div>
""", unsafe_allow_html=True)
...
<h2 class="risk-medium">{medium_priority}</h2>
<p class="small-muted">Requires review</p>
</div>
""", unsafe_allow_html=True)
...
<h4>PQC Readiness</h4>
<h2>{score}/100</h2>
<p class="small-muted">Organization readiness score</p>
</div>
""", unsafe_allow_html=True)
