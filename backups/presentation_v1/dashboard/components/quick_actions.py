...
def show():
    ...
    with c2:
        ...
        action_card(
            "Executive Report",
            "Download the latest executive PDF assessment.",
            "Download PDF",
            "pdf_report",
            download=(
    ...
    with c3:
        ...
        action_card(
            "Assessment Package",
            "Download the complete assessment package including PDF, TXT, inventory and metadata.",
            "Download ZIP",
            "package",
            download=(
                Path("reports/EQMP_Assessment_Package.zip"),
                "EQMP_Assessment_Package.zip",
            ),
        )
